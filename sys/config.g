; General preferences
M98 P"/sys/lib/globals/init.g"			; Create the global variables

M575 P1 S1 B57600                       ; enable support for PanelDue
G90                                     ; send absolute coordinates...
M83                                     ; ...but relative extruder moves
M550 P{global.printerName}              ; set printer name
M669 K1                                 ; CoreXY
...
; Axis Limits
M98 P"/sys/printer_size_config.g"		; Set the printer size limits
...
; Tools
M563 P0 S{global.hotendName} D0 H1 F0   ; define tool 0
...
; Z-Probe
M98 P{global.probeInitialize}				; set the Z probe values
